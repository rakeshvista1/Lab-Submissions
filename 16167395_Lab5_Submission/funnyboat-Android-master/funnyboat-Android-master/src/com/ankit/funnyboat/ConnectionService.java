...
public class ConnectionService extends IntentService implements
	...
	public ConnectionService() {
		...
		Log.d("RAKESH", "in ConnectionService constructor");
	...
	public void onCreate() {
		...
		Log.d("RAKESH", "in ConnectionService oncreate");
	...
	protected void onHandleIntent(Intent intent) {
		// TODO Auto-generated method stub
		Log.d("RAKESH", "in connection service onHanldeIntent");
		startScan();
	}

	private void broadCast() {
		// TODO Auto-generated method stub
		Log.d("RAKESH", "in connection service broadcast");
		Intent intent = new Intent("com.ankit.funnyboat");
	...
	public void onLeScan(BluetoothDevice device, int rssi, byte[] scanRecord) {
		// TODO Auto-generated method stub
		Log.d("RAKESH", "in connectionservice onlescan method");
		Log.d("RAKESH", "New LE Device: " + device.getName() + " @ " + rssi);
		/*
		...
		if (DEVICE_NAME.equals(device.getName())) {
			Log.d("RAKESH",
					"in connectionservice onlescan method devicename equal");
	...
	private void startScan() {
		Log.d("RAKESH", "start scan");
		if (mBluetoothAdapter.startLeScan(this)) {
			Log.d("RAKESH", "started");
		} else {
			Log.d("RAKESH", "not started");
		}
	...
	private BluetoothGattCallback mGattCallback = new BluetoothGattCallback() {
		...
		public void onConnectionStateChange(BluetoothGatt gatt, int status,
				int newState) {
			Log.d("RAKESH", "Connection State Change: " + status + " -> "
		...
		public void onServicesDiscovered(BluetoothGatt gatt, int status) {
			Log.d("RAKESH", "Services Discovered: " + status);
			// mHandler.sendMessage(Message.obtain(null, MSG_PROGRESS,
			// "Enabling Sensors..."));
			/*
		...
		public void onCharacteristicRead(BluetoothGatt gatt,
			...
			if (ACCELEROMETER_DATA_CHAR.equals(characteristic.getUuid())) {
				Log.d("RAKESH", " sensor accelerometer");
		...
		public void onCharacteristicChanged(BluetoothGatt gatt,
			...
			Log.d("RAKESH", "in onCharacteristicChanged");

			if (ACCELEROMETER_DATA_CHAR.equals(characteristic.getUuid())) {
				// mHandler.sendMessage(Message.obtain(null, MSG_ACCELEROMETER,
				// characteristic));
				// Log.d("sensor", "acceleromter changed");
				updateAccelerometerCals(characteristic);
			}
			if (GYROSCOPE_DATA_CHAR.equals(characteristic.getUuid())) {
				// mHandler.sendMessage(Message.obtain(null, MSG_GYROSCOPE,
				// characteristic));
				// Log.d("sensor", "gyroscope changed");
	...
	private void updateAccelerometerCals(
		...
		Log.d("RAKESH", "in updateAccelerometerCals");
		...
		d = Math.sqrt(Math.pow((x - x1), 2) + Math.pow((y - y1), 2)
				+ Math.pow((z - z1), 2));
		if (d >= 0.3 && !trigger) {
			Log.d("RAKESH", "start updateAccelerometerCals");
			trigger = true;
		} else if (d <= 0.1 && trigger) {
			Log.d("RAKESH", "end updateAccelerometerCals");
			trigger = false;
			try {
				Log.d("RAKESH", "end updateAccelerometerCals try");
				File returnType = whichGesture(dataPoints);
				// Log.d("data", returnType.getAbsolutePath());
				Log.d("RAKESH", "end updateAccelerometerCals datapoints size : "+dataPoints.size());
				Log.d("RAKESH", "end updateAccelerometerCals return type is : "+t.test(returnType));
				...
				Log.d("RAKESH", "test failing"+e.getMessage());
			}
			dataPoints.clear();
		}
		if (trigger) {
