...
public class Operations {
	...
	{
		 try {
	            URL url = new URL("http://134.193.136.127:8080/HbaseWS/jaxrs/generic/hbaseCreate/RakeshTable3/GeoLocation:Date:Accelerometer");
	...
	{
		 try {
	            URL url = new URL("http://134.193.136.127:8080/HbaseWS/jaxrs/generic/hbaseInsert/RakeshTable3/-home-cloudera-RakeshSensor2.txt/GeoLocation:Date:Accelerometer");
	            BufferedReader in = new BufferedReader(new InputStreamReader(url.openStream()));
	            String inputLine; 
